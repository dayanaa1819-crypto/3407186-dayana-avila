...
console.log('=========================================');
console.log('[E-commerce de Libros Usados] - FICHA 3407186');
console.log('=========================================');
console.log('');
...
console.log('Categoría:       [Novela Clásica]');
...
console.log('Valor principal:    ', 25000);
...
console.log('Estado booleano 1 : ', false);
...
console.log('Total registros:  ', 1500);
...
console.log('  ¡Descubre grandes historias con nuestros libros usados!');
