...
const bank = {
  ...
  // Propiedad de contacto o ubicación (si aplica)
   contact: {
     email: 'serviciosfinancieros@payflow.com',
     phone: '3104863989',
